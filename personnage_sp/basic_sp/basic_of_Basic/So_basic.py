...
class So_basic:
    __slots__ = "v_min","v","v_max","m","m_max","m_min","Bv_max"
...
class so_basic_data:
    ...
    """
    def __init__(self,file="basic_file.csv",id=-1,*args,**kwargs):      #-1 pour (automatique), mais il vas pouras renvoyer l'id quand il seras demander
        self.file = file
